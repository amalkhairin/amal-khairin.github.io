...
<body>
    ...
    <div id="content-item" class="container-fluid">
        <h4 id="title-app" class="mx-3 my-3">Android Apps</h4>
        <div class="row mx-3">
            <?php foreach ($data as $item) { ?>
                <div class="card m-2" style="width: 14rem;">
                    <img class="card-img-top" src="<?= $item['icon_image'] ?>" alt="app-icon">
                    <div class="card-body">
                        <h5 class="card-title"><?= $item['name'] ?></h5>
                        <p class="card-text"><?= substr($item['desc'], 0, 34) . '...' ?></p>
                        <a href="<?php echo base_url('./Detail') . '?id=' ?><?= $item['id'] ?>" id="btn-details" class="btn">Details</a>
                    </div>
                </div>
            <?php } ?>
        </div>
